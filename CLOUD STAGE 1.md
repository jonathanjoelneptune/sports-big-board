...
After deploying v4.2.2, perform the one-time upload described in `SOUNDTRACK SETUP.md`. For the current project:
...
## v4.2.2 one-push GitHub deployment
...
[deploy] Backend v4.2.2-... is healthy.
```
...
2. Upload `sports-big-board-v4.2.2.zip` to Cloud Shell and extract it.
...
```bash
cd ~/storage/downloads/sports-big-board-v4.2.2/sports-big-board-v4.2.2
...
### v4.2.2 catalog-preserving preflight
