# Sports Big Board v3.0.9 — Cloud Stage 1

v3.0.9 turns the existing local Sports Big Board server into an always-on Stage 1 cloud deployment without changing the core event/media/Game Center architecture.

## v3.0.9 one-push GitHub deployment
...
2. Upload `sports-big-board-v3.0.9.zip` to Cloud Shell and extract it.
