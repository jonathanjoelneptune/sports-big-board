...
# queue with the clicked game's media fixed at the front. v5.5.0 performs that
...
print('PASS v5.5.0 retains league/day score queue while yielding construction off the score click')
