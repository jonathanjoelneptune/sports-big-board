# Sports Big Board v4.1.29 Soundtrack Setup

v4.1.29 supports the 113-track Sports Big Board soundtrack while keeping the ~408 MiB MP3 library in a **private Google Cloud Storage bucket**. Public Access Prevention may remain enforced.
...
Place the six soundtrack ZIPs in one Cloud Shell directory and run from a v4.1.29 checkout:
