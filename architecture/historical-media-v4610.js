/* Sports Big Board v4.7.14 — historical database-first media hardening.
...
*/
(() => {
  if (window.SBB_HISTORICAL_MEDIA_HARDENING?.version === '4.7.14') return;
  ...
  const state = {version:'4.7.14',generation:0,barriers:new Map(),deferredFill:new Set(),lastReport:new Map()};
