/* Sports Big Board v5.3.18 — user-pause-safe early pause recovery.
...
(() => {
  'use strict';
  if(window.SBB_EARLY_PAUSE_RECOVERY?.version==='5.3.18')return;
  ...
  function boundedSameItemRecovery(){
    ...
    let acted=false;try{if(typeof tuneProgramIndexV5==='function'&&typeof currentIndex!=='undefined'){tuneProgramIndexV5(currentIndex,{userInitiated:false,reason:'v5.3.18 confirmed unexpected startup pause'});acted=true;}}catch(_){}
