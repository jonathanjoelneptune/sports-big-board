/* Sports Big Board v4.4.1 — Three-Tier Foundation Certification.
...
(() => {
  'use strict';
  const RELEASE=String(window.SBB_RELEASE_VERSION||window.SBB_CORE?.version||'4.4.1');
  const CERT_SCHEMA=2;
