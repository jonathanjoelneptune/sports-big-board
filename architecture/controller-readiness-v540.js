/* Sports Big Board v5.4.0 — Controller Readiness / Interaction Architecture.
...
(() => {
  'use strict';
  if(window.SBB_CONTROLLER_READINESS?.version==='5.4.0')return;
  const VERSION='5.4.0';
  ...
  function audit({log=true}={}){
    ...
    if(log){if(result.ok)console.info('[SBB v5.4.0] controller readiness audit PASS',result);else console.warn('[SBB v5.4.0] controller readiness audit WARN',result);}
