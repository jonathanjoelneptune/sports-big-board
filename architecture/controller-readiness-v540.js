/* Sports Big Board v5.4.7 — Controller Readiness / Interaction Architecture.
...
(() => {
  'use strict';
  if(window.SBB_CONTROLLER_READINESS?.version==='5.4.7')return;
  const VERSION='5.4.7';
  ...
  function audit({log=true}={}){
    ...
    if(log){if(result.ok)console.info('[SBB v5.4.7] controller readiness audit PASS',result);else console.warn('[SBB v5.4.7] controller readiness audit WARN',result);}
