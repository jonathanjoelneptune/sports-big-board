/* Sports Big Board v5.1.10 — Unified Runtime App Store.
   ...
   projected into a compact event record before entering ANY v5 event authority.
   v5.1.10 makes this projection the reconstitution boundary for SelectedEvent too.
...
(() => {
  'use strict';
  if (window.SBB_APP_STORE?.version === '5.1.10') return;
