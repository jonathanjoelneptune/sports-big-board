/* Sports Big Board v5.0.4 — Unified Runtime App Store.
...
(() => {
  'use strict';
  if (window.SBB_APP_STORE?.version === '5.0.4') return;
  ...
  function reduce(current,action){
    ...
    switch(type){
      ...
      case 'CLEAR_EVENT': {
        ...
        // v5.0.4: SelectedEvent is inseparable from an active event-owned playback
