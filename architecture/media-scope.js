/* Sports Big Board v4.1.10 — media scope is independent from recap quality. */
(() => {
  ...
  function classify(item,{away='',home='',eventId='',league=''}={}){
    ...
    if(['espn-event-video','mlb-game-content','nfl-event-video','official-nfl-club-site','official-nfl-game-highlights','official-nfl-extended-highlights','official-nhl-game-recap','official-nhl-condensed-game','official-mls-match-snapshot','official-mls-match-highlights','official-premierleague-match-highlights','trusted-nbc-epl-extended'].includes(st))return SCOPE.GAME;
