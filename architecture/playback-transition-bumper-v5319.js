/* Sports Big Board v5.4.8 — transition bumper authority, startup-safe.
   v5.4.8 used a MutationObserver on the legacy loading overlay while other
   playback code was also changing that same class. On some browsers those two
   writers could create a hot mutation loop immediately after launch. v5.4.8
...
(() => {
  ...
  function recoverStuck(id){
    ...
    try{if(typeof manualQueueAdvance==='function')manualQueueAdvance(1,{reason:'v5.4.8 transition timeout'});}catch(_){ }
  }
