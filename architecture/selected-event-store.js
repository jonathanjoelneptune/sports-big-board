/* Sports Big Board v5.1.10 — SelectedEvent Event Reconstitution authority.
...
(() => {
  'use strict';
  if(window.SBB_SELECTED_EVENT?.version==='5.1.10')return;
  let current=null;
  let revision=0;
  ...
  window.SBB_SELECTED_EVENT=Object.freeze({version:'5.1.10',select,clear,get:snapshot,subscribe,keyOf,project,get revision(){return revision;}});
})();
