...
for surface in [f'ui/browse-curated-programming-v535.css?v={version}',f'<script src="ui/browse-curated-programming-v535.js?v={version}"></script>']:
...
print('PASS v5.3.5 league-attached Browse submenu, reliable close, automatic chronological queue, and explicit matchup queue titles')
