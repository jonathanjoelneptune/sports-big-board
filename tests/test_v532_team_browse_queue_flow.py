...
for surface in [f'ui/browse-curated-programming-v534.css?v={version}',f'<script src="ui/browse-curated-programming-v534.js?v={version}"></script>']:
...
assert "$('sbbCurationPlay')?.addEventListener('click',playAll)" in js
...
print('PASS v5.3.4 league-attached Browse submenu, reliable close, automatic chronological queue, and explicit matchup queue titles')
