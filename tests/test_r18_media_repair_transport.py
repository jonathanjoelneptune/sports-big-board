"""R18 media-repair transport regression guards.
...
class R18MediaRepairTransportTests(unittest.TestCase):
    ...
    def test_r18_requeues_r17_exhausted_actionable_jobs_once(self):
        self.assertIn('R18-MEDIA-REPAIR-TRANSPORT', AUDIT)
        self.assertIn("R18_MEDIA_REPAIR_TRANSPORT", AUDIT)
