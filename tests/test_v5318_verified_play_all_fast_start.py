...
for token in [
    ...
    'v5.3.18 Play All fast same-game fallback',
    'v5.3.18 Play All skipped slow verified source',
...
print('PASS v5.3.18 compact league subnav + completed verified Play All + bounded fast-start fallback')
