...
for token in [
    ...
    'v5.4.0 Play All fast same-game fallback',
    'v5.4.0 Play All skipped slow verified source',
...
print('PASS v5.4.0 compact league subnav + completed verified Play All + bounded fast-start fallback')
