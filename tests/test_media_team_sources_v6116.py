...
with tempfile.TemporaryDirectory() as td:
    ...
    # NCAA uses short institutional names/slug abbreviations while provider event
    # names often append mascots.
    ...
    # Provider aliases remain first-class and abbreviation normalization is applied.
    ...
    # The relaxed path must not let a single ambiguous institution token claim a
    # neighboring school.
