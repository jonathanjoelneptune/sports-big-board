...
assert '<title>Sports Big Board — v5.1.21</title>' in index
assert 'architecture/tennis-presentation.js?v=5.1.21' in index
assert (root/'VERSION').read_text().strip()=='5.1.21'
...
print('PASS v5.1.21 backend-first tennis ribbon architecture invariants')
