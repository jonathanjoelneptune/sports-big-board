...
for surface in [
    f'ui/browse-curated-programming-v532.css?v={version}',
    f'ui/workspace-viewport-fit-v531.css?v={version}',
    f'<script src="ui/browse-curated-programming-v532.js?v={version}"></script>',
...
for token in [
    "const VERSION='5.3.2'",'placeBrowseControls()','positionPopover()','primeEntityCatalog()',
...
for token in ["const VERSION='5.3.2'","body.classList.contains('sbb-game-center-side')",'viewportHeight()-top-bottomGap',"sbb:browse-layout",'SBB_WORKSPACE_VIEWPORT_FIT']:
...
print('PASS v5.3.2 contextual subnav Browse, date-headed scored timeline, automatic chronological queue, and open/closed viewport fit')
