...
for token in [
    "const VERSION='5.3.20'",'placeBrowseControls()','positionPopover()','primeEntityCatalog()',
...
for token in ["const VERSION='5.3.20'","body.classList.contains('sbb-game-center-side')",'viewportHeight()-top-bottomGap',"sbb:browse-layout",'SBB_WORKSPACE_VIEWPORT_FIT']:
...
print('PASS v5.3.20 contextual subnav Browse, date-headed scored timeline, automatic chronological queue, and open/closed viewport fit')
