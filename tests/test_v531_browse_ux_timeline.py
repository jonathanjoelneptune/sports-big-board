...
for token in [
    "const VERSION='5.5.0'",'placeBrowseControls()','positionPopover()','primeEntityCatalog()',
...
for token in ["const VERSION='5.5.0'","body.classList.contains('sbb-game-center-side')",'viewportHeight()-top-bottomGap',"sbb:browse-layout",'SBB_WORKSPACE_VIEWPORT_FIT']:
...
print('PASS v5.5.0 contextual subnav Browse, date-headed scored timeline, automatic chronological queue, and open/closed viewport fit')
