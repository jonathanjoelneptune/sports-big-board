...
for token in [
    ...
    "v5.3.12 same-game curated fallback",
    "v5.3.12 next special-event highlight after unavailable source",
...
assert 'v5.3.12 — standings-first hierarchy' in league_css
...
print('PASS v5.3.12 special-event playback isolation + Game Center freshness + division/Wild Card League View')
