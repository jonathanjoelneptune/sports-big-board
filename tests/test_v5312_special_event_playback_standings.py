...
for token in [
    ...
    "v5.4.4 same-game curated fallback",
    "v5.4.4 next special-event highlight after unavailable source",
...
assert 'v5.4.4 — standings-first hierarchy' in league_css
...
print('PASS v5.4.4 special-event playback isolation + Game Center freshness + division/Wild Card League View')
