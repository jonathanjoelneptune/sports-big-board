...
for token in [
    ...
    "v5.4.8 same-game curated fallback",
    "v5.4.8 next special-event highlight after unavailable source",
...
assert 'v5.4.8 — standings-first hierarchy' in league_css
...
print('PASS v5.4.8 special-event playback isolation + Game Center freshness + division/Wild Card League View')
