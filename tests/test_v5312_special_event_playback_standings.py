...
for token in [
    ...
    "v5.3.14 same-game curated fallback",
    "v5.3.14 next special-event highlight after unavailable source",
...
assert 'v5.3.14 — standings-first hierarchy' in league_css
...
print('PASS v5.3.14 special-event playback isolation + Game Center freshness + division/Wild Card League View')
