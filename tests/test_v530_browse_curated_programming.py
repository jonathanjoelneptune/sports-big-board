...
assert f'ui/browse-curated-programming-v533.css?v={version}' in index
assert f'<script src="ui/browse-curated-programming-v533.js?v={version}"></script>' in index
...
print('PASS v5.3.3 Browse + Curated Programming core: league facets, entity history, favorites, and chronological Play All queue')
