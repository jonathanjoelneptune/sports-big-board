...
# queue with the clicked game's media fixed at the front. v5.4.5 performs that
...
print('PASS v5.4.5 retains league/day score queue while yielding construction off the score click')
