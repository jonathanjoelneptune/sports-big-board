...
# queue with the clicked game's media fixed at the front. v5.4.4 performs that
...
print('PASS v5.4.4 retains league/day score queue while yielding construction off the score click')
