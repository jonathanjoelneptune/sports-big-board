...
class MilestoneConsoleUnitTests(unittest.TestCase):
    def test_bounded_console_tracks_api_playback_and_errors(self):
        ...
        c=MilestoneConsole('4.2.0',max_events=220)
        ...
        snap=c.snapshot(frontend_version='4.2.0')
...
class MilestoneReleaseContractTests(unittest.TestCase):
    def test_release_console_is_wired_front_and_backend(self):
        ...
        for token in ('openMilestoneConsoleBtn','milestoneConsoleModal','architecture/milestone-console.js?v=4.2.0','milestoneConsoleOutput'):
    ...
    def test_playback_session_is_loaded_before_soundtrack_and_app(self):
        html=(ROOT/'index.html').read_text(encoding='utf-8')
        ps='architecture/playback-session.js?v=4.2.0'; mc='architecture/milestone-console.js?v=4.2.0'; st='architecture/site-soundtrack.js?v=4.2.0'; app='app.js?v=4.2.0'
