...
class CloudStage1Tests(unittest.TestCase):
    def test_frontend_loads_api_runtime_before_bootstrap(self):
        ...
        self.assertIn('config.js?v=3.0.4',html); self.assertIn('api-runtime.js?v=3.0.4',html)
        self.assertLess(html.index('api-runtime.js?v=3.0.4'),html.index('BOOT_START'))
    ...
    def test_version_file_matches_server(self):
        self.assertEqual((ROOT/'VERSION').read_text().strip(),'3.0.4')
        self.assertIn('APP_VERSION = "3.0.4"',(ROOT/'server.py').read_text())
