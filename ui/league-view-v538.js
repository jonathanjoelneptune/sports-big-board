/* Sports Big Board v5.3.19 — League View + recap context.
...
(() => {
  'use strict';
  if (window.SBB_LEAGUE_VIEW?.version === '5.3.19') return;
  ...
  function currentLeague(){
    ...
    // v5.3.19 authority order: what is PLAYING beats what was BROWSED. Curated
  ...
  function conferenceBoard(rows,league){
    ...
    // v5.3.19: paired conference/division columns share the same row slots.
