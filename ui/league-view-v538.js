/* Sports Big Board v5.4.6 — League View + recap context.
...
(() => {
  'use strict';
  if (window.SBB_LEAGUE_VIEW?.version === '5.4.6') return;
  ...
  function currentLeague(){
    ...
    // v5.4.6 authority order: what is PLAYING beats what was BROWSED. Curated
  ...
  function conferenceBoard(rows,league){
    ...
    // v5.4.6: paired conference/division columns share the same row slots.
