/* Sports Big Board v5.4.7 — League View + recap context.
...
(() => {
  'use strict';
  if (window.SBB_LEAGUE_VIEW?.version === '5.4.7') return;
  ...
  function currentLeague(){
    ...
    // v5.4.7 authority order: what is PLAYING beats what was BROWSED. Curated
  ...
  function conferenceBoard(rows,league){
    ...
    // v5.4.7: paired conference/division columns share the same row slots.
