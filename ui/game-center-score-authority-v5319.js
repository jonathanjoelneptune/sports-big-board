/* Sports Big Board v5.4.5 — Game Center score authority, observer-free.
   v5.4.5 repaired stale provider 0-0 soccer summaries by watching Game Center DOM.
   ...
   v5.4.5 moves score authority to the DATA boundary instead. SBB_GAME_CENTER get()
