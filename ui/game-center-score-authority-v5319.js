/* Sports Big Board v5.4.3 — Game Center score authority, observer-free.
   v5.4.3 repaired stale provider 0-0 soccer summaries by watching Game Center DOM.
   ...
   v5.4.3 moves score authority to the DATA boundary instead. SBB_GAME_CENTER get()
