...
class HistoryRepository:
    ...
    v3.0.6 keeps the legacy date/league JSON rows for fast score hydration while
    ...
    def audit_catalog(self, *, date_from="", date_to="", league="", best_tier="", status="", search="", limit=100, offset=0,
        ...
        v3.0.6 deliberately exposes an *effective* audit status in addition to the raw
