# Sports Big Board v3.0.6 — Cloud Stage 1

v3.0.6 turns the existing local Sports Big Board server into an always-on Stage 1 cloud deployment without changing the core event/media/Game Center architecture.

## v3.0.6 one-push GitHub deployment
...
2. Upload `sports-big-board-v3.0.6.zip` to Cloud Shell and extract it.
