# Sports Big Board v3.0.6 Architecture
...
### v3.0.6 historical discovery completion
...
`HISTORY_DISCOVERY_VERSION = 10` provides a non-destructive soft reindex: old scores/assets remain authoritative, while older completion/retry metadata cannot suppress the Green-gap and quality reassessment.
...
## v3.0.6 Cloud Stage 1 deployment boundary
