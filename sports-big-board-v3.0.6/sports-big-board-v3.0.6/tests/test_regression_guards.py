...
class RegressionGuards(unittest.TestCase):
    def test_architecture_loaded_before_app(self):
        ordered=['core-model.js?v=3.0.6','architecture/score-date-store.js?v=3.0.6','architecture/event-identity.js?v=3.0.6','architecture/media-classifier.js?v=3.0.6','architecture/playback-transports.js?v=3.0.6','architecture/provider-health.js?v=3.0.6','architecture/sport-media-policy.js?v=3.0.6','architecture/media-manifest.js?v=3.0.6','architecture/media-resolver.js?v=3.0.6','architecture/game-center-policy.js?v=3.0.6','architecture/selected-event-store.js?v=3.0.6','architecture/game-center-contract.js?v=3.0.6','architecture/media-work-priorities.js?v=3.0.6','architecture/editorial-packages.js?v=3.0.6','ui/player-visibility.js?v=3.0.6','ui/info-drawer.js?v=3.0.6','ui/settings-view.js?v=3.0.6','ui/history-audit.js?v=3.0.6','ui/game-center-view.js?v=3.0.6','app.js?v=3.0.6']
    ...
    def test_score_ribbon_has_arbitrary_date_controls_on_both_edges(self):
        ...
        self.assertIn('v3.0.6 — score ribbon recovery',STYLES)
        self.assertIn('v3.0.6 — historical Date Browser',STYLES)
    ...
    def test_v302_desktop_ribbon_scroll_and_large_full_surface_date_arrows(self):
        ...
        self.assertIn('v3.0.6 — desktop score-ribbon browsing + full-surface date arrows',STYLES)
    ...
    def test_v290_historical_media_is_server_owned_event_catalog_with_runtime_truth(self):
        ...
        self.assertIn('HISTORY_DISCOVERY_VERSION = 10',SERVER)
    ...
    def test_v305_audit_projects_unknown_into_actionable_statuses(self):
        self.assertIn('PENDING INDEX',INDEX)
    ...
    def test_v281_history_catalog_persists_scores_media_and_backfills_in_background(self):
        ...
        self.assertIn('while not _history_server_idle(): time.sleep(5)',SERVER)
    ...
    def test_v306_green_gap_queue_targets_games_not_blue_asset_volume(self):
        ...
        self.assertIn('[SBB green-gap]',SERVER)
