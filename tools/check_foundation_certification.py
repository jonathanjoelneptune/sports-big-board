...
require('node tests/test_tier1_restoration_semantics.js' in verify,'VERIFY.sh does not execute Tier 1 restoration-semantics behavior test')
if errors:
