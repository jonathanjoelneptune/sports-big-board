#!/usr/bin/env python3
"""Static release gate for Sports Big Board v4.3.1 three-tier Foundation Certification."""
...
require(version=='4.3.1',f'expected VERSION 4.3.1, found {version!r}')
...
html=text('index.html');cert=text('architecture/foundation-certification.js');milestone=text('architecture/milestone-console.js');app=text('app.js');gc=text('ui/game-center-view.js');styles=text('styles.css');verify=text('VERIFY.sh')
