...
# v5.5.0: reclaim deployment-only storage BEFORE uploading/extracting another
...
# v5.5.0 invariant: AUDIT_ONLY_DATABASE_AUTHORITY must not dynamically dispatch
