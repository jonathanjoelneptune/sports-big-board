...
# v5.4.7: reclaim deployment-only storage BEFORE uploading/extracting another
...
# v5.4.7 invariant: AUDIT_ONLY_DATABASE_AUTHORITY must not dynamically dispatch
...
# quiescent. v5.4.7 first runs CHECK-ONLY. A structurally healthy normalized
