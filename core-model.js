...
(() => {
  ...
  window.SBB_CORE=Object.freeze({version:'4.7.10',TYPES,SPORTS,COMPETITIONS,competition,enabledCompetitions,participant,event,media,mediaAsset,mediaPackage,moment,statSection,gameCenter,editorialPackage,playable});
})();
