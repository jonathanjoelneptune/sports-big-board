...
(() => {
  ...
  window.SBB_CORE=Object.freeze({version:'4.6.15',TYPES,SPORTS,COMPETITIONS,competition,enabledCompetitions,participant,event,media,mediaAsset,mediaPackage,moment,statSection,gameCenter,editorialPackage,playable});
})();
