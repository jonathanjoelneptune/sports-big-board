# Sports Big Board v4.2.0 Soundtrack Setup

v4.2.0 supports the 113-track Sports Big Board soundtrack while keeping the ~408 MiB MP3 library in a **private Google Cloud Storage bucket**. Public Access Prevention may remain enforced.

## Playback behavior in v4.2.0
...
Place the six soundtrack ZIPs in one Cloud Shell directory and run from a v4.2.0 checkout:
