...
## SendInput
The v5.4.7 R1 Windows helper remains compatible with v5.4.9 and retains SendInput fullscreen delivery plus command-result acknowledgement.

## v5.4.9 Team Select refinements
