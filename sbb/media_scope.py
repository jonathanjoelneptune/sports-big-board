"""Media scope + Silver collection classification for Sports Big Board v4.1.13.
...
# SILVER_SCOPES is the actual v4.1.13 presentation/promotion contract.
...
def classify_with_reason(item, *, league="", date="", away="", home=""):
    ...
    # v4.1.13: studio/reaction/postgame-show programming can remain in SOURCE_MEDIA,
    ...
    if source_type in {"espn-event-video","mlb-game-content","nfl-event-video","official-nfl-club-site",
                        ...
                        "official-premierleague-match-highlights","trusted-nbc-epl-extended","official-nfl-game-highlights","official-nfl-extended-highlights","official-nfl-public-video","official-nfl-team-video"}:
