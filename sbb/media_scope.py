"""Media scope + Silver collection classification for Sports Big Board v4.1.15.
...
# SILVER_SCOPES is the actual v4.1.15 presentation/promotion contract.
...
def classify_with_reason(item, *, league="", date="", away="", home=""):
    ...
    # v4.1.15: studio/reaction/postgame-show programming can remain in SOURCE_MEDIA,
