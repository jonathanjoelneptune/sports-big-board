"""Media scope + Silver collection classification for Sports Big Board v4.1.23.
...
# SILVER_SCOPES is the actual v4.1.23 presentation/promotion contract.
...
def _round_collection_signal(item, league=""):
    ...
    # v4.1.23: a trusted playlist collector may have already resolved Matchweek N
...
def classify_with_reason(item, *, league="", date="", away="", home=""):
    ...
    # v4.1.23: studio/reaction/postgame-show programming can remain in SOURCE_MEDIA,
