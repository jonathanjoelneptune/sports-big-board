"""Canonical competition/provider registry shared by server services (v4.1.10).
...
COMPETITIONS = {
    ...
    "NFL":{"id":"NFL","sportId":"american-football","name":"National Football League","enabled":True,"scoreProvider":"espn","mediaProviders":["nfl-game-highlights","espn","nfl-club","nfl-feed","highlightly","youtube"],"gameCenterProvider":"highlightly","gameCenterFallback":"espn"},
