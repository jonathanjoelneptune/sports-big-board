"""Canonical competition/provider registry shared by server services (v4.1.13).
...
COMPETITIONS = {
    ...
    "NFL":{"id":"NFL","sportId":"american-football","name":"National Football League","enabled":True,"scoreProvider":"espn","mediaProviders":["nfl-public-video","nfl-team-video","espn","nfl-feed","highlightly","youtube"],"gameCenterProvider":"highlightly","gameCenterFallback":"espn"},
    ...
    "EPL":{"id":"EPL","sportId":"football","name":"Premier League","enabled":True,"scoreProvider":"espn","mediaProviders":["premierleague-official","nbc-epl-extended","espn","club-sites","highlightly","youtube"],"gameCenterProvider":"highlightly","gameCenterFallback":"espn"},
