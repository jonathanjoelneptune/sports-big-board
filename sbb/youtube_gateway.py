"""YouTube API gateway for Sports Big Board v4.1.20.
...
class YouTubeGateway:
    ...
    def __init__(self, user_agent: str = "SportsBigBoard/4.1.20", state_file=None, quota_timezone="America/Los_Angeles"):
