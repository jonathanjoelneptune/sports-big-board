"""Provider routing registry for v4.2.2.
...
MEDIA_ADAPTERS={
    ...
    # Retained as catalog/audit identities only. nfl_club_sources.py blocks these
    # league-owned playlist adapters from satisfying NFL Green/Purple GAME media.
    "nfl-youtube-playlist":{"kind":"retired-official-youtube-playlist","transport":["YOUTUBE"],"competitions":["NFL"],"reliability":0},
    "nfl-youtube-playlist-quick":{"kind":"retired-official-youtube-playlist","transport":["YOUTUBE"],"competitions":["NFL"],"reliability":0},
    "nfl-youtube-playlist-extended":{"kind":"retired-official-youtube-playlist","transport":["YOUTUBE"],"competitions":["NFL"],"reliability":0},
    "nfl-public-video":{"kind":"official-web","transport":["DIRECT_VIDEO","EXTERNAL"],"competitions":["NFL"],"reliability":99},
    "nfl-team-video":{"kind":"official-team-web","transport":["DIRECT_VIDEO","EXTERNAL"],"competitions":["NFL"],"reliability":100},
    "nfl-public-video-quick":{"kind":"official-web","transport":["DIRECT_VIDEO","EXTERNAL"],"competitions":["NFL"],"reliability":99},
    "nfl-public-video-extended":{"kind":"official-web","transport":["DIRECT_VIDEO","EXTERNAL"],"competitions":["NFL"],"reliability":99},
    "nfl-team-video-quick":{"kind":"official-team-web","transport":["DIRECT_VIDEO","EXTERNAL"],"competitions":["NFL"],"reliability":100},
    "nfl-team-video-extended":{"kind":"official-team-web","transport":["DIRECT_VIDEO","EXTERNAL"],"competitions":["NFL"],"reliability":100},
    "nfl-club":{"kind":"official-web","transport":["DIRECT_VIDEO","EXTERNAL"],"competitions":["NFL"],"reliability":98},
