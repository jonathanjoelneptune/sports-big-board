"""Sports Big Board v5.3.16 — cached League View read model.
...
def _http_json(url, timeout=7.0):
    req = Request(url, headers={"User-Agent": "SportsBigBoard/5.3.16", "Accept": "application/json"})
