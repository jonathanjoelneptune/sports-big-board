"""Sports Big Board v5.4.8 — cached League View read model.
...
def _http_json(url, timeout=7.0):
    req = Request(url, headers={"User-Agent": "SportsBigBoard/5.4.8", "Accept": "application/json"})
