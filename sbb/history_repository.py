...
class HistoryRepository:
    ...
    def _connect(self):
        ...
        mode is persistent database state, so v4.1.29 configures it in ``_init_db``
    ...
    def release_rebuild_pending_events(self, current_discovery_version):
        """Release artificial v4.1.29 migration cooldowns already persisted in production.
        ...
        with self._lock, closing(self._connect()) as conn:
            ...
            for raw in rows or []:
                ...
                if state==ASSIGNED:
                    ...
                    if competing:
                        # v4.1.29 distinguishes a broad candidate being encountered
    ...
    def repair_collection_associations(self, classifier_version=MEDIA_CLASSIFIER_VERSION, force=False):
        ...
        v4.1.29 treats collection membership as fully derived state.  Classifier
    ...
    def media_objective_summary(self):
        """Persisted v4.1.29 objective/category counts for operator audit."""
    ...
    def ribbon_media_for_date(self, date, leagues=None, include_failed=False):
        ...
        v4.1.29 performed one ``event_media`` query per score card (the classic
        N+1 pattern).  This v4.1.29 path resolves every assigned source asset for
    ...
    def put_collection_media(self, scope, league, period_key, rows, *, collection_kind="ROUNDUP", return_stats=False):
        ...
        v4.1.29 keeps the legacy integer return by default, but can return precise
    ...
    def roundup_media(self, date, league=None):
        ...
        # v4.1.29: Silver is a latency-sensitive read. WAL/query_only means this
    ...
    def source_enrichment_events(self, source_versions, *, floor_date="", today="", now=None, preferred_league="", strict_preferred=False, limit=96, newest_first=True):
        ...
        v4.1.29 gives NFL, MLS and EPL independent Quick/Green and Extended/Purple
        ...
        if strict_preferred and preferred and preferred in leagues:
            # v4.1.29 strict rule-migration lane: query only the assigned league.
