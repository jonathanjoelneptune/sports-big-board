...
python3 tests/test_v610_canonical_certification.py
...
python3 -m py_compile sbb/team_focus_v537.py sbb/league_view_v538.py sbb/__init__.py sbb/canonical_shadow_v600.py sbb/canonical_certification_v610.py
...
echo "PASS: v6.1.0 Canonical Slate Certification Shadow preflight complete"
