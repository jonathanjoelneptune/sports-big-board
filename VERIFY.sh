...
echo "Sports Big Board v5.2.12 release + splash preload + motion + OpenAI rate-limit preflight"
...
echo "PASS: v5.2.12 atomic release, splash preload, motion, and OpenAI rate-limit preflight complete"
