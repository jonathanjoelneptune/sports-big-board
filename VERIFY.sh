...
echo "Sports Big Board v5.2.11 release + motion + OpenAI rate-limit preflight"
...
echo "PASS: v5.2.11 atomic release, motion, and OpenAI rate-limit preflight complete"
