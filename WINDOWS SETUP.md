# Windows setup — Sports Big Board v4.1.27
...
Once stored, v4.1.27, v2.7, v3.0, etc. on that same Windows account reuse the file automatically. You should not need to paste keys again after each upgrade.
