# Windows setup — Sports Big Board v3.0.5
...
Once stored, v3.0.5, v2.7, v3.0, etc. on that same Windows account reuse the file automatically. You should not need to paste keys again after each upgrade.
