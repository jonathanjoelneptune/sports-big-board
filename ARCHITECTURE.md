# Sports Big Board v4.1.15 Architecture
...
### v4.1.15 normalized historical catalog baseline
...
### v4.1.15 targeted Rule Game Catch-up v3
...
The MLS/EPL Silver replay remains a dedicated post-seed worker, but v4.1.15 makes its accounting idempotent: candidates examined, qualifying, new unique assets, reused assets, new links, duplicate links, and rejects are tracked separately. A persisted Rule Collection Catch-up v2 completion marker means reboot does not restart finished migration work.
...
### v4.1.15 fail-closed event association
...
### v4.1.15 structural preflight boundary
...
## v4.1.15 bounded discovery concurrency
...
## v4.1.15 tier-aware provider staging
...
### Fixed historical seed boundary (v4.1.15)
...
## v4.1.15 official content acquisition adapters
