# Sports Big Board v4.1.29 Architecture

## v4.1.29 operator/read and playback boundary
...
## v4.1.29 site soundtrack boundary
...
- `architecture/site-soundtrack.js` — persistent no-repeat site soundtrack, crossfades, ducking, controls, and Cloud Storage audio resolution
